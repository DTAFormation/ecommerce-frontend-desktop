...
.factory('AuthenticationService', ['Base64', '$http', '$cookieStore', '$rootScope', '$timeout',
    function (Base64, $http, $cookieStore, $rootScope, $timeout) {
        ...
        service.Login = function (username, password, callback) {
            ...
            // fonction de test pour vérifier le fonctionnement de l'authentification
            $timeout(function(){
 ...
 //fonction permettant de limiter les caractères utilisables et gère l'encodage. (code récupérer)
.factory('Base64', function () {
    // jshint ignore:start
 
    //variable permettant de gérer la table de décalage pour encodage simple
    var keyStr = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
 
    //encodage des variables en entrées
    return {
        ...
        //décodage des variables en entrées
